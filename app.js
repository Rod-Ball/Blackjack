...
var deck=[],
    ...
    dealerHand=[],
    value=enValue,
    suitOpts=[zel,poke,stnd,gravity],
    suit=stnd;
...
var dealerScoreBox = document.getElementById("dealerScore"),
    ...
    makeSuitBtn = document.getElementById('createSuit'),
    questionBoxSuite = document.getElementById('questionBox'),
...
//This function will automatically create different suit buttons within the options dropdown box
function createButton(){
    for(let i = 0; i<suitOpts.length; i++){
        var button = document.createElement('button');
        button.innerText=suitOpts[i].name;
        button.classList.add("space", "dropdownButton");
...
// This function creates the user's deck by placing each card in the deck array
...
//This function switches different cards in random spaces within the deck array 
...
function showPlayerScoreBox(){
    ...
    var newSpace = document.createElement('label'),
        scoreInfo="Player's Score: " + playerScore;
...
function showDealerScoreBox(){
    ...
    var newSpace = document.createElement('label'),
        scoreInfo="Dealer's Score: " + dealerScore;
    newSpace.innerText =scoreInfo;
